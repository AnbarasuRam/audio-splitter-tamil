...
A simple Streamlit app to split audio files and transcribe Tamil speech using Sarvam AI.

## Features

- **Audio Upload**: Support for MP3, M4A, WAV files
- **Auto-Split**: Automatically splits long audio into 15-minute chunks
- **Tamil Transcription**: Uses Sarvam AI's speech-to-text API
...
5. Set the main file path to `streamlit-app/app.py`
6. Click "Deploy"
...
1. Enter your Sarvam AI API key (get one from https://dashboard.sarvam.ai)
...
This app uses the [Sarvam AI Speech-to-Text API](https://docs.sarvam.ai):
...
├── transcriber.py      # Sarvam AI transcription service
...
- API rate limits may apply based on your Sarvam AI plan
